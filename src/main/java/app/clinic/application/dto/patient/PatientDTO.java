 ...
 * Used for API responses containing patient data.
 */
public class PatientDTO {
    ...
    public PatientDTO(String cedula, String username, String fullName, String birthDate,
                     String gender, String address, String phoneNumber, String email,
                     int age, EmergencyContactDTO emergencyContact, InsurancePolicyDTO insurancePolicy) {
        this.cedula = cedula;
    ...
    public String toString() {
        return String.format("PatientDTO{cedula='%s', username='%s', fullName='%s', gender='%s', age=%d}",
                           cedula, username, fullName, gender, age);
    }
}