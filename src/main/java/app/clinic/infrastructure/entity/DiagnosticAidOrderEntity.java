...
/**
 * JPA entity representing diagnostic aid orders table in the database.
 * Specialized table for diagnostic aid order items.
 */
@Entity
...
public class DiagnosticAidOrderEntity {
    ...
    @Column(name = "diagnostic_aid_name", nullable = false, length = 100)
    ...
    public DiagnosticAidOrderEntity(OrderEntity order, Integer itemNumber, String diagnosticAidName,
                                   Integer quantity, BigDecimal cost, boolean requiresSpecialistAssistance,
